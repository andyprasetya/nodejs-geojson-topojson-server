...
server.router = {
  ...
  'geojson-server/getAllGeoJSONFilePoints' : geojsonfile.getAllGeoJSONFilePoints,
  'geojson-server/getAllGeoJSONFileLines' : geojsonfile.getAllGeoJSONFileLines,
  'geojson-server/getAllGeoJSONFilePolygons' : geojsonfile.getAllGeoJSONFilePolygons,
  'geojson-server/getAllPgSQLPoints' : geopgsql.getAllPgSQLPoints,
  'geojson-server/getAllPgSQLLines' : geopgsql.getAllPgSQLLines,
  'geojson-server/getAllPgSQLPolygons' : geopgsql.getAllPgSQLPolygons,
