...
server.router = {
  ...
  'geojson-server/getAllSamplePoints' : geodatahandlers.getAllPoints,
  'geojson-server/getAllSampleLines' : geodatahandlers.getAllLines,
  'geojson-server/getAllSamplePolygons' : geodatahandlers.getAllPolygons,
  'geojson-server/getAllMySQLPoints' : geodatahandlers.getAllMySQLPoints,
